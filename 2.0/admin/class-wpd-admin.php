...
//        }        
    ...
    private function get_general_settings() {
        ...
        $customizer_page = array(
            'title' => __('Customizer Page', 'wpd'),
            'desc' => __('This setting allows the plugin to locate the page where customizations are made.', 'wpd'),
        ...
        /* array_push($options, $icons_options_begin);
          array_push($options, $this->get_upload_icon_field(__("Grid","wpd"),"grid","wpc-general-options"));
          array_push($options, $this->get_upload_icon_field(__("Clear","wpd"),"clear","wpc-general-options"));
          array_push($options, $this->get_upload_icon_field(__("Delete","wpd"),"delete","wpc-general-options"));
          array_push($options, $this->get_upload_icon_field(__("Duplicate","wpd"),"duplicate","wpc-general-options"));
          array_push($options, $this->get_upload_icon_field(__("Send to back","wpd"),"back","wpc-general-options"));
          array_push($options, $this->get_upload_icon_field(__("Bring to front","wpd"),"bring","wpc-general-options"));
          array_push($options, $this->get_upload_icon_field(__("Vertical flip","wpd"),"flipV","wpc-general-options"));
          array_push($options, $this->get_upload_icon_field(__("Horizontal flip","wpd"),"flipH","wpc-general-options"));
          array_push($options, $this->get_upload_icon_field(__("Horizontal center","wpd"),"centerH","wpc-general-options"));
          array_push($options, $this->get_upload_icon_field(__("Vertical center","wpd"),"centerV","wpc-general-options"));
          array_push($options, $this->get_upload_icon_field(__("Undo","wpd"),"undo","wpc-general-options"));
          array_push($options, $this->get_upload_icon_field(__("Redo","wpd"),"redo","wpc-general-options"));
    ...
    private function get_uploads_settings() {
        ...
        //  array_push($options,$this->get_upload_icon_field(__("Uploads tab icon","wpd"),"icon_upload","wpc-upload-options"));
        // array_push($options, $uploads_tab_color);
        //  array_push($options, $uploads_tab_selected_color);
...
//            'desc' => __('Number of images on pdf output', 'wpd'),
...
//            'title' => __('PDF Format', 'wpd'),
////            'desc' => __('Number of images column on pdf output', 'wpd'),
//            'id' => 'wpc-output-options[pdf-width]',
//            'type' => 'text',
//            'default' => '',
//            'class' => 'chosen_select_nostd',
//            'css' => 'min-width:300px;',
...
//            'title' => __('PDF Format', 'wpd'),
////            'desc' => __('Number of images column on pdf output', 'wpd'),
//            'id' => 'wpc-output-options[pdf-height]',
//            'type' => 'text',
//            'default' => '',
//            'class' => 'chosen_select_nostd',
//            'css' => 'min-width:300px;',
...
//                                array(
//                                        'desc' 	=> __( 'Radius', 'wpd' ),
//                                        'id' 		=> 'wpc-texts-options[text-radius]',
//                                        'type' 		=> 'checkbox',
//                                        'default'=>'yes',
//                                        'checkboxgroup'		=> ''
//                                ),
...
//                                array(
//                                        'desc' 	=> __( 'Spacing', 'wpd' ),
//                                        'id' 		=> 'wpc-texts-options[text-spacing]',
//                                        'type' 		=> 'checkbox',
//                                        'default'=>'yes',
//                                        'checkboxgroup'		=> ''
//                                ),
    ...
    function notify_customization_page_missing() {
        ...
        if (!extension_loaded('zip'))
            echo '<div class="error">
                   <p><b>Product Customizer: </b>ZIP extension not loaded on this server. You won\'t be able to generate zip outputs.</p>
                </div>';
    }
